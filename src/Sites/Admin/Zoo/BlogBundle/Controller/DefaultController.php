...
class DefaultController extends Controller
{
    public function indexAction($page = 1)
    {
        ...
        return $this->render('AdminZooBlogBundle:Default:index.html.twig', ["drafts"=>$draftPosts, "published"=>$publishedPosts, "categories"=>$categories, "alaune"=>$front, "alaunebn"=>$frontBN, "tags"=>$tags]);
    }
}
